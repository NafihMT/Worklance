...
public interface IJobApplicationService
{
    ...
    Task<JobApplicationResponse> GetApplicationByIdAsync(int applicationId, string userId);
    Task<JobApplicationResponse> AcceptApplicationAsync(int applicationId, string userId);
    Task<JobApplicationResponse> RejectApplicationAsync(int applicationId, string userId);
    Task<JobApplicationResponse> UpdateApplicationStatusAsync(int applicationId, string userId, UpdateJobApplicationStatusRequest request);
}
